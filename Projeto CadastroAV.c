...
int i, tam, j, pse;
	...
	if(arq==NULL){
		system("cls");
		printf("Erro ao abrir o arquivo Carros na funcao Carro novo e ler seu conteudo.\n\n");
		system("pause");
	}else{
		system("cls");
	...
	system("cls");
	if(arq==NULL){
		printf("Erro ao abrir o arquivo Carros na funcao Carro novo.\n\n");
		system("pause");
	}else{
		...
		if(fwrite(&x,sizeof(Clientes),1,arq) == NULL){
			system("cls");
			printf("Erro ao salvar informacoes no arquivo durante o cadastro de novos carros.\n\n");
			system("pause");
		}
	}
	fclose(arq);
...
void listar_produto(){
	...
	if(arq==NULL){
		system("cls");
		printf("Erro ao abrir o arquivo Games na funcao Listar_vedendores.\n\n");
		system("pause");
	}else{
		system("cls");
...
void remover_produto(){
	...
	if(arq==NULL){
		system("cls");
		printf("Erro ao abrir o arquivo Vedendores na funcao Demitir_vedendores e ler seu conteudo.\n\n");
		system("pause");
	}else{
		system("cls");
		tam = fread(&y[0],sizeof(Produto),100,arq);
	...
	if(arq==NULL){
		system("cls");
		printf("Erro ao abrir o arquivo Vedendores na funcao Demitir_vedendores e escrever conteudo.\n\n");
		system("pause");
	}else{
		for(i=0;i<tam;i++){
			if(i!=index){
				if(fwrite(&y[i],sizeof(Produto),1,arq) == NULL){
					system("cls");
					printf("Erro ao salvar informacoes no arquivo durante o cadastro de novos vedendores.\n\n");
					system("pause");
				}
			}
		}
...
int Pesquisar_jogo_codigo(int codigo){
	...
	if(arq==NULL){
		system("cls");
		printf("Erro ao abrir o arquivo Vedendores na funcao Pesquisar_vedendores.\n\n");
		system("pause");
	}else{
		tam = fread(&x[0],sizeof(Produto),100,arq);
	}
...
int Login(){
	...
	do{
		...
		scanf("%i", &senha);
			...
			if(arq==NULL){
				system("cls");
				printf("Erro ao abrir o arquivo Vedendores na funcao Listar_vedendores.\n\n");
				system("pause");
			}else{
				tam = fread(&x[0],sizeof(Clientes),100,arq);
			}
